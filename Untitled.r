...
# CONVERSION FORMATO IMAGEN .JP2 A .TIF (GEOTIFF)
...
# composicion stack
comp_mult_ST <- stack(b2, b3, b4, b8)
...
# CREACION DEL DATASET (DATA.FRAME)
...
# parcelas verdad terreno
trainData <- shapefile("D:/prac_ANN/datos_entrenamiento/datos_entrenamiento.shp")
responseCol <- "class"

trainData

# extraccion de los valores de pixel de la imagen
...
dfTrain <- dfAll[inBuild,] # 70% train
...
# PREDICCION CON EL DATASET DE VALIDACION
